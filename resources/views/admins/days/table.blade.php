...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{route('days.create')}}"><i class="fa fa-plus-circle text-success pull-right">Add new days</i></a>
        </div>
                ...
                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$day->name}}</td>
                            <td {{Helper::getStatusClass($day->status)}}>{{Helper::getStatusValue($day->status)}}</td>
                            <td>{{$day->code}}</td>
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-default btn-flat" href="{{route('days.edit', $day->id)}}"><i class="fa fa-edit"></i></a>

                                    <a class="btn btn-danger btn-flat ml-2 btnDelete" href="#DeleteConfirmation"
                                     data-toggle="modal" data-url="{{route('days.destroy' ,$day->id)}}">
...
<x-Modals.delete :title="'Days'"></x-Modals.delete>
